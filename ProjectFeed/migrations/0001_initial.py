...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, verbose_name='profile')),
                ...
                ('registration', models.CharField(default=ProjectFeed.models.code_registration, max_length=15, verbose_name='registration_code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ProjectFeed.Features')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ProjectFeed.Location')),
            ],
        ),
        migrations.AddField(
            model_name='location',
            name='features',
            field=models.ManyToManyField(through='ProjectFeed.LocationFeatures', to='ProjectFeed.Features'),
        ),
        migrations.AddField(
            model_name='location',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_comments', to='ProjectFeed.Reviews')),
