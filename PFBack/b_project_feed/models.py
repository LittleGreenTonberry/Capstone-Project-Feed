...
class Profile(models.Model):
    ...
    favorites = models.TextField(verbose_name="user_favorites",default="No Favorites Yet!")
...
class Location(models.Model):
    ...
    business_hours = models.CharField(verbose_name="location_hours",max_length=50)
...
class Comments(models.Model):
    ...
    review=models.ForeignKey(Reviews, related_name='user_comments', on_delete=models.CASCADE,)
    content=models.TextField(verbose_name='review_comment',)
    com_create=models.DateTimeField(verbose_name='date_comment_created', auto_now_add=True)
...
class Favorites(models.Model):
    user=models.ForeignKey(User, related_name="favorite_places", on_delete=models.SET_NULL, null=True, )
